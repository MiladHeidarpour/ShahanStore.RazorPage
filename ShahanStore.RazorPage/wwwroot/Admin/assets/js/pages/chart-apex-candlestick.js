var colors = ["#6ac75a", "#fa5c7c"],
  ...
  colors = (chart.render(), ["#6ac75a", "#fa5c7c"]),
  optionsCandlestick =
  ...
  colors = (chartCandlestick.render(), ["#ce7e7e", "#ffbc00"]),
  options =
  ...
  options =
      ...
      (colors = dataColors.split(",")),
    {
      ...
      title: { text: "نمودار شمعدان - محور گروه X", align: "left" },
  ...
  options =
      ...
      (colors = dataColors.split(",")),
    {
      ...
      chart: { height: 380, type: "line" },
          title: { text: "نمودار شمعی", align: "left" },
      stroke: { width: [3, 1] },
