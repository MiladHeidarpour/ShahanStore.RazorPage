var colors = ["#ce7e7e", "#6ac75a", "#fa5c7c"],
  ...
  options = {
    ...
    series: [
      { name: "محصول A", data: [44, 55, 41, 67, 22, 43, 21, 49] },
      { name: "محصول B", data: [13, 23, 20, 8, 13, 27, 33, 12] },
      { name: "محصول C", data: [11, 17, 15, 15, 21, 14, 15, 13] },
    ],
    xaxis: {
      categories: [
        "2011 Q1",
      ...
      points: [
        {
          ...
          label: {
            borderColor: "#ce7e7e",
            offsetY: 0,
            style: { color: "#fff", background: "#ce7e7e" },
            text: "موز خوب است",
          },
        },
      ],
...
var options = {
  ...
  optionsQuarter =
    ...
    )).render(),
    {
      ...
      xaxis: { axisBorder: { show: !1 } },
      yaxis: { labels: { show: !1 } },
      title: { text: "نتایج سه ماهه", offsetX: 10 },
      tooltip: {
        x: {
          formatter: function (t, o) {
