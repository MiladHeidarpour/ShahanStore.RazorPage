for (
  var colors = ["#ffbc00"],
    ...
    options = {
      ...
      series: [
        { name: "دسک تاپ", data: [30, 41, 35, 51, 49, 62, 69, 91, 126] },
      ],
      title: { text: "روند محصول به ماه", align: "center" },
      grid: {
    ...
    colors = (chart.render(), ["#ce7e7e", "#6ac75a", "#fa5c7c", "#ffbc00"]),
    ...
    options = {
      ...
      series: [
        { name: "زیاد - 2018", data: [28, 29, 33, 36, 32, 32, 33] },
        { name: "کم - 2018", data: [12, 11, 14, 18, 17, 13, 13] },
      ],
      title: { text: "متوسط ​​درجه حرارت بالا و پایین", align: "left" },
      grid: {
        row: { colors: ["transparent", "transparent"], opacity: 0.2 },
        borderColor: "#f1f3fa",
      },
...
var colors = ["#fa5c7c"],
  ...
  options = {
    ...
    colors: (colors = dataColors ? dataColors.split(",") : colors),
    title: { text: "حرکت قیمت سهام", align: "left" },
    grid: {
      row: { colors: ["transparent", "transparent"], opacity: 0.2 },
      borderColor: "#f1f3fa",
    },
  ...
  options =
      ...
      (colors = dataColors.split(",")),
    {
      ...
      annotations: {
        ...
        xaxis: [
          ...
          },
          {
            ...
            label: {
              borderColor: "#B3F7CA",
              style: { fontSize: "10px", color: "#fff", background: "#00E396" },
              offsetY: -10,
              text: "دامنه محور x",
            },
          },
      ...
      title: { text: "خط با حاشیه نویسی", align: "left" },
      labels: series.monthDataSeries1.dates,
      xaxis: { type: "datetime" },
    }),
  colors =
  ...
  colors = (chartline2.render(), ["#6c757d"]),
...
(colors = ["#6ac75a"]),
  ...
  (options = {
    chart: { type: "line", height: 344 },
    stroke: { curve: "stepline" },
    dataLabels: { enabled: !1 },
    series: [{ data: [34, 44, 54, 21, 12, 43, 33, 23, 66, 66, 58] }],
    colors: (colors = dataColors ? dataColors.split(",") : colors),
    title: { text: "نمودار پله ای", align: "left" },
...
(dataColors = $("#chart-line2").data("colors")) &&
  (colors = dataColors.split(","));
var options = {
    series: [
      {
  ...
  colors =
    ...
    ["#ffbc00"]),
  optionsLine =
    ((dataColors = $("#chart-line").data("colors")) &&
      (colors = dataColors.split(",")),
    {
      series: [{ data: data }],
      chart: {
