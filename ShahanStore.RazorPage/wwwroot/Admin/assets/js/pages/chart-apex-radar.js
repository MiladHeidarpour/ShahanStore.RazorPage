var colors = ["#ce7e7e"],
  ...
  options = {
    ...
    series: [{ name: "سری 1", data: [80, 50, 30, 40, 100, 20] }],
    colors: (colors = dataColors ? dataColors.split(",") : colors),
    labels: ["ژانویه", "فوریه", "راهپیمایی", "ماه آوریل", "ماه مه", "ژوئن"],
  },
  ...
  options = {
    chart: { height: 350, type: "radar" },
    series: [{ name: "سری 1", data: [20, 100, 40, 30, 50, 80, 33] }],
    labels: [
      "یکشنبه",
      "دوشنبه",
      "سه شنبه",
  ...
  colors =
    ...
    ["#ce7e7e", "#02a8b5", "#fd7e14"]),
  dataColors = $("#radar-multiple-series").data("colors"),
  options = {
    chart: { height: 350, type: "radar" },
    series: [
      { name: "سری 1", data: [80, 50, 30, 40, 100, 20] },
      { name: "سری 2", data: [20, 30, 40, 80, 20, 80] },
      { name: "سری 3", data: [44, 76, 78, 13, 43, 10] },
    ],
    stroke: { width: 0 },
    fill: { opacity: 0.4 },
    markers: { size: 0 },
