var colors = ["#f28888"],
  ...
  options = {
    ...
    series: [{ name: "سهام یاب", data: series.monthDataSeries1.prices }],
    title: { text: "تجزیه و تحلیل اساسی سهام", align: "left" },
    subtitle: { text: "حرکات قیمت", align: "left" },
  ...
  colors = (chart.render(), ["#ce7e7e", "#6c757d"]),
...
(colors = ["#f8b0f9", "#ce7e7e", "#669776"]),
  (dataColors = $("#area-timeSeries").data("colors")) &&
    (colors = dataColors.split(",")),
  (options = {
    series: [
      { name: "محصول ش", data: dataSet[0] },
      { name: "محصول ب", data: dataSet[1] },
      { name: "محصول ز", data: dataSet[2] },
    ],
    ...
    title: {
      text: "داده های نامنظم در سری زمانی",
      align: "left",
      offsetX: 14,
    },
    tooltip: { shared: !0 },
