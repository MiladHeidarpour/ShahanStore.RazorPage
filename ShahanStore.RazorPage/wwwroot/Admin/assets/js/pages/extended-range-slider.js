...
function crossUpdate(e, t) {
  var i;
  lockedState &&
    ((e -= lockedValues[(i = slider1 === t ? 0 : 1) ? 0 : 1] - lockedValues[i]),
    t.noUiSlider.set(e));
}
...
lockButton &&
  lockButton.addEventListener("click", function () {
    (lockedState = !lockedState),
      (this.textContent = lockedState ? "باز کردن" : "قفل");
  }),
    ...
    e &&
      e.noUiSlider.on("update", function (e, t, i, r, n) {
        ...
        for (var d = 1; d < n.length; d++)
          (!p[d] || n[d] - n[d - 1] > s) &&
            ((l[++o] = []), (c[o] = []), (a[o] = [])),
            p[d] && (l[o].push(d), c[o].push(e[d]), a[o].push(n[d]));
...
const sliderPrimary = document.getElementById("slider-primary"),
  ...
  colorOptions = { start: 127, connect: "lower", range: { min: 0, max: 255 } },
  defaultVertical =
