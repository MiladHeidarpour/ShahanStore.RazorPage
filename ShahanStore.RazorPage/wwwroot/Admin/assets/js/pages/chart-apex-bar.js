var colors = ["#39afd1"],
  ...
  options = {
    ...
    series: [
      { name: "سری 1", data: [44, 55, 41, 64, 22, 43, 21] },
      { name: "سری 2", data: [53, 32, 33, 52, 13, 44, 32] },
    ],
    xaxis: {
  ...
  options = {
    ...
    stroke: { show: !1 },
    series: [
      { name: "چلیک", data: [44, 55, 41, 37, 22, 43, 21] },
      { name: "گوساله چشمگیر", data: [53, 32, 33, 52, 13, 43, 32] },
      { name: "تصویر تانک", data: [12, 17, 11, 9, 15, 11, 20] },
      { name: "شیب سطل", data: [9, 7, 5, 8, 6, 9, 4] },
      { name: "بچه متولد شده", data: [25, 12, 19, 32, 25, 24, 10] },
    ],
    xaxis: {
  ...
  colors =
    ...
    ["#ffbc00", "#39afd1", "#6c757d", "#e3eaef", "#ce7e7e"]),
  ...
  labels =
    ...
    Array.apply(null, { length: 39 }).map(function (o, e) {
      return e + 1;
    })),
  options = {
    chart: {
  ...
  options = {
    ...
    dataLabels: {
      ...
      formatter: function (o, e) {
        return e.w.globals.labels[e.dataPointIndex] + ":  " + o;
      },
      offsetX: 0,
