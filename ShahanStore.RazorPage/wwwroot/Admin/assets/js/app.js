        ...
        Array.from(e).forEach(function (e) {
            ...
            "flatpickr" == e.getAttribute("data-provider")
                ? ((n = e.attributes),
                    ...
                    (t.locale = "fa"), // Set locale to Farsi
                    n["data-date-format"] &&
                ...
                ((a = {}),
                    ...
                    (a.locale = "fa"), // Set locale to Farsi
                    n["data-time-hrs"] &&
                    ((a.enableTime = !0),
                        (a.noCalendar = !0),
                        (a.dateFormat = "H:i"),
...
class ThemeCustomizer {
    ...
    initConfig() {
        ...
        try {
            const savedConfig = localStorage.getItem("__OSEN_CONFIG__");
            if (savedConfig) {
                const parsedConfig = JSON.parse(savedConfig);
                this.config = Object.assign({}, this.config, parsedConfig);
            }
        } catch (e) {
    ...
    changeLayoutColor(e) {
        ...
        const themeIcon = document.getElementById("light-dark-mode-icon");
        if (themeIcon) {
            if (e === "dark") {
                themeIcon.className = "ti ti-sun fs-22"; // آیکون خورشید
            } else {
                themeIcon.className = "ti ti-moon fs-22"; // آیکون ماه
            }
        }
        this.setSwitchFromConfig();
    }
