...
var randomizeArray = function (t) {
  ...
  spark1 =
      ...
      (colors = dataColors.split(",")),
    {
      ...
      fill: { opacity: 0.2 },
      series: [{ name: "فروش ساله", data: randomizeArray(sparklineData) }],
      yaxis: { min: 0 },
      colors: colors,
      title: { text: " 424,652 تومان", offsetX: 20, style: { fontSize: "24px" } },
      subtitle: { text: "فروش", offsetX: 20, style: { fontSize: "14px" } },
    }),
  colors =
  ...
  spark2 =
      ...
      (colors = dataColors.split(",")),
    {
      ...
      fill: { opacity: 0.2 },
      series: [
        { name: "هزینه ها ", data: randomizeArray(sparklineData) },
      ],
      yaxis: { min: 0 },
      colors: colors,
          title: { text: "235,312 تومان", offsetX: 20, style: { fontSize: "24px" } },
      subtitle: { text: "هزینه ها", offsetX: 20, style: { fontSize: "14px" } },
    }),
  colors =
  ...
  spark3 =
      ...
      (colors = dataColors.split(",")),
    {
      ...
      yaxis: { min: 0 },
      colors: colors,
          title: { text: " 135,965 تومان", offsetX: 20, style: { fontSize: "24px" } },
      subtitle: { text: "سود", offsetX: 20, style: { fontSize: "14px" } },
    }),
  colors =
