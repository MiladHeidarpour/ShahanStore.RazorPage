var colors = ["#ce7e7e", "#6ac75a", "#fa5c7c"],
  ...
  colors = (chart.render(), ["#ce7e7e", "#6ac75a", "#fa5c7c"]),
  options =
  ...
  colors =
    ...
    ["#ce7e7e", "#6ac75a", "#fa5c7c"]),
  dataColors = $("#horizontal-boxplot").data("colors"),
  options = {
    series: [
      {
        data: [
          { x: "دسته A", y: [54, 66, 69, 75, 88] },
          { x: "دسته B", y: [43, 65, 69, 76, 81] },
          { x: "دسته C", y: [31, 39, 45, 51, 59] },
          { x: "دسته D", y: [39, 46, 55, 65, 71] },
          { x: "دسته E", y: [29, 31, 35, 39, 44] },
          { x: "دسته F", y: [41, 49, 58, 61, 67] },
          { x: "دسته G", y: [54, 59, 66, 71, 88] },
        ],
      },
    ],
    chart: { type: "boxPlot", height: 350 },
