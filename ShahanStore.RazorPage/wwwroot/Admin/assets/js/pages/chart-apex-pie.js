var colors = ["#ce7e7e", "#6c757d", "#6ac75a", "#fa5c7c", "#e3eaef"],
  ...
  colors =
    (chart.render(), ["#39afd1", "#ffbc00", "#313a46", "#fa5c7c", "#6ac75a"]),
  ...
  colors =
    ...
    ["#ce7e7e", "#6c757d", "#6ac75a", "#fa5c7c", "#e3eaef"]),
  ...
  colors =
    ...
    ["#39afd1", "#ffbc00", "#313a46", "#fa5c7c", "#6ac75a"]),
  ...
  options = {
    ...
    series: [44, 55, 41, 17, 15],
    colors: (colors = dataColors ? dataColors.split(",") : colors),
    labels: ["کمدی", "عمل", "باکره", "درام", "وحشت"],
